...
class HybridSuperResolutionModel(nn.Module):
    def __init__(self, target_scale=None, smoothing='balanced', device='cuda', output_size=(512, 512)):
        ...
        # Gestione dimensione output dinamica per test light
        ...
        # Stage 2: HAT FULL STANDARD
        if HAT_Arch:
            try:
                self.stage2 = HAT_Arch(
                    img_size=64, patch_size=1, in_chans=1, embed_dim=180,          
                    ...
                    qkv_bias=True, upscale=2, img_range=1., 
    ...
    def forward(self, x):
        ...
        # Interpolazione dinamica finale

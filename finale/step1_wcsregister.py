...
# ============================================================================
# CONFIGURAZIONE PATH ASSOLUTI (DA V1)
# ============================================================================
...
# 3. Dove salvare i log (ORA DENTRO LA CARTELLA DATA)
LOG_DIR_ROOT = ROOT_DATA_DIR / "logs"

# 4. Cartella dove si trovano questi script (dinamica o fallback su scripts)

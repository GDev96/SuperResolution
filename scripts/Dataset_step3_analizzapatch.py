"""
STEP 5: ESTRAZIONE PATCH - VERSIONE CUSTOM 80x80 / 512x512
Features:
...
- Dimensioni target: 
    * Hubble HR: 512x512
    * Observatory LR: 80x80 (Scale factor: 6.4x)
...
# ============================================================================
# PARAMETRI PATCH - CONFIGURAZIONE RICHIESTA
# ============================================================================
# Hubble rimane 512x512 (HR)
TARGET_SIZE_HUBBLE = 512    
# Observatory impostato a 80x80 (LR)
TARGET_SIZE_GROUND = 80     

# Nota sul fattore di scala: 512 / 80 = 6.4x
